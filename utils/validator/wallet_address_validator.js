...
module.exports = {
   ...
   */
  validate: async function (address, currencyNameOrSymbol, networkType, addressFormats) {
    ...
    if (currency && currency.validator) {
      ...
      return await currency.validator.isValidAddress(address, currency, networkType, addressFormats)
    }
